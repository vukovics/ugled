...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Plumbing Parts
	 * @var $inverse	- added by Plumbing Parts
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Plumbing Parts:
	// Color scheme
	if ($scheme && !plumbing_parts_param_is_off($scheme) && !plumbing_parts_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !plumbing_parts_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Plumbing Parts color scheme in the row
	if ($scheme && !plumbing_parts_param_is_off($scheme) && !plumbing_parts_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php plumbing_parts_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php plumbing_parts_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
