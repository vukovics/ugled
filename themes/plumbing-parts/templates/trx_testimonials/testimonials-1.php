...
if ( !function_exists( 'plumbing_parts_template_testimonials_1_theme_setup' ) ) {
	add_action( 'plumbing_parts_action_before_init_theme', 'plumbing_parts_template_testimonials_1_theme_setup', 1 );
	function plumbing_parts_template_testimonials_1_theme_setup() {
		plumbing_parts_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 1/', 'plumbing-parts'),
...
// Template output
if ( !function_exists( 'plumbing_parts_template_testimonials_1_output' ) ) {
	function plumbing_parts_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
