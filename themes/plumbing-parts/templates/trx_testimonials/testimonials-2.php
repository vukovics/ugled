...
if ( !function_exists( 'plumbing_parts_template_testimonials_2_theme_setup' ) ) {
	add_action( 'plumbing_parts_action_before_init_theme', 'plumbing_parts_template_testimonials_2_theme_setup', 1 );
	function plumbing_parts_template_testimonials_2_theme_setup() {
		plumbing_parts_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'plumbing-parts')
		));
	}
}

// Template output
if ( !function_exists( 'plumbing_parts_template_testimonials_2_output' ) ) {
	function plumbing_parts_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
