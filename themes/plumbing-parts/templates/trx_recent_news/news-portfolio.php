...
if ( !function_exists( 'plumbing_parts_template_news_portfolio_theme_setup' ) ) {
	add_action( 'plumbing_parts_action_before_init_theme', 'plumbing_parts_template_news_portfolio_theme_setup', 1 );
	function plumbing_parts_template_news_portfolio_theme_setup() {
		plumbing_parts_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'plumbing-parts'),
...
// Template output
if ( !function_exists( 'plumbing_parts_template_news_portfolio_output' ) ) {
	function plumbing_parts_template_news_portfolio_output($post_options, $post_data) {
