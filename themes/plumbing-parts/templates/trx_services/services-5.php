...
if ( !function_exists( 'plumbing_parts_template_services_5_theme_setup' ) ) {
	add_action( 'plumbing_parts_action_before_init_theme', 'plumbing_parts_template_services_5_theme_setup', 1 );
	function plumbing_parts_template_services_5_theme_setup() {
		plumbing_parts_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'plumbing-parts'),
...
// Template output
if ( !function_exists( 'plumbing_parts_template_services_5_output' ) ) {
	function plumbing_parts_template_services_5_output($post_options, $post_data) {
