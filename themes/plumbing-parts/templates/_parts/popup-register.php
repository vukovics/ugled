		...
		<form name="registration_form" method="post" class="popup_form registration_form">
			...
			<div class="form_left">
				...
				<div class="popup_form_field agree_field">
					...
					<label for="registration_agree"><?php esc_html_e('I agree with', 'plumbing-parts'); ?></label> <a href="#"><?php esc_html_e('Terms &amp; Conditions', 'plumbing-parts'); ?></a>
				</div>
				<div class="popup_form_field submit_field"><input type="submit" class="submit_button" value="<?php esc_attr_e('Sign Up', 'plumbing-parts'); ?>"></div>
			</div>
