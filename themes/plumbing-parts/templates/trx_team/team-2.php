...
if ( !function_exists( 'plumbing_parts_template_team_2_theme_setup' ) ) {
	add_action( 'plumbing_parts_action_before_init_theme', 'plumbing_parts_template_team_2_theme_setup', 1 );
	function plumbing_parts_template_team_2_theme_setup() {
		plumbing_parts_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_pagination sc_slider_pagination_bottom sc_slider_nocontrols',*/
			'title'  => esc_html__('Team /Style 2/', 'plumbing-parts'),
...
// Template output
if ( !function_exists( 'plumbing_parts_template_team_2_output' ) ) {
	function plumbing_parts_template_team_2_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			...
			><div class="sc_team_item_avatar column-2_5">
					<?php plumbing_parts_show_layout($post_options['photo']); ?>
